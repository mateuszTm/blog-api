...
public class PostControllerTest {
	...
	public void getPostsSortedByDateAscending() throws Exception {		
		mockMvc.perform(
			...
			.andExpect(MockMvcResultMatchers.jsonPath("$.content[0].date").value("2020-08-09 12:11:12"))
			.andExpect(MockMvcResultMatchers.jsonPath("$.content[1].date").value("2020-08-09 13:11:12"))
			.andExpect(MockMvcResultMatchers.jsonPath("$.content[2].date").value("2020-08-09 14:11:12"));
	}
}
